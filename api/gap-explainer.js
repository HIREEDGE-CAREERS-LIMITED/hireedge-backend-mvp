// POST /api/gap-explainer
// Body: { gapType, duration, previousRole, targetRole, reasonDetails? }
  ...
  try {
    ...
    req.on("end", async () => {
      ...
      return res.status(200).json({
        ...
        emailParagraph,
        note:
          "These are templates for explaining your gap in a clear, honest and professional way. You can adjust wording to match your personal situation.",
        durationText
      });
    });
  } catch (err) {
