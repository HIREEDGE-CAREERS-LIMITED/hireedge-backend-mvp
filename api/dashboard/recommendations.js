// ============================================================================
// api/dashboard/recommendations.js
// HireEdge — Vercel Serverless API
//
// GET  /api/dashboard/recommendations?role=data-analyst&skills=SQL,Python&target=data-architect&yearsExp=3
// POST /api/dashboard/recommendations  { role, skills, target, yearsExp }
// ============================================================================
...
export default function handler(req, res) {
  ...
  try {
    let role, skills, target, yearsExp;
    ...
    const result = generateDashboardRecommendations({ role, skills, target, yearsExp });

    if (!result.ok) return res.status(404).json(result);
    return res.status(200).json(result);
  } catch (err) {
    console.error("[dashboard/recommendations]", err);
